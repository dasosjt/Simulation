...
while N < 2000:
    fitness = np.zeros((population_size,5))
    ...
    for n in range(len(fitness)):
        if sum(fitness[n])/3 < 0.8 or fitness[n][0] == 0 or fitness[n][1] == 0 or fitness[n][2] == 0 or fitness[n][3] == 0:
...
while not found:
    ...
    if fitness[max_candidate_index][0] == 1 and fitness[max_candidate_index][1] == 1 and fitness[max_candidate_index][2] == 1 and fitness[max_candidate_index][3] == 1 and fitness[max_candidate_index][4] == 1:
        found = True
    else:
        c += 1
